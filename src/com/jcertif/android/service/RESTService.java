...
public class RESTService extends IntentService {
    ...
    public static final String EXTRA_HTTP_VERB       = "com.jcertif.android.EXTRA_HTTP_VERB";
    public static final String EXTRA_PARAMS          = "com.jcertif.android.EXTRA_PARAMS";
        ...
        try {            
            ...
            switch (verb) {
                ...
                case POST: {
                    ...
                    if (params != null) {
                        StringEntity formEntity = new StringEntity(params.getString(KEY_JSON_PLAYLOAD));
